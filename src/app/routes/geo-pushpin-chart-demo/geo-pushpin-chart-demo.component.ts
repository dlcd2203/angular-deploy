...
@Component({
  selector: 'app-geo-pushpin-chart-demo',
  templateUrl: './geo-pushpin-chart-demo.component.html',
  styleUrls: ['./geo-pushpin-chart-demo.component.css']
})
export class GeoPushpinChartDemoComponent implements OnInit {
  constructor() { }

  geoPushpinChartArray = [
    {
